...
class LivingroomView extends GetView<LivingroomController> {
  final LivingroomController realtimeController = Get.put(LivingroomController());
   LivingroomView({Key? key}) : super(key: key);
  ...
  Widget _buildTemperature(String text, String imagePath) {
    var temperatureValue = realtimeController.sensorData['dht11']?['temp2'] ?? 'N/A';
    return Container(
      width: 190,
      height: 260,
  ...
  Widget _buildHumidity(String text, String imagePath) {
    var humidityValue = realtimeController.sensorData['dht11']?['hum2'] ?? 'N/A';
    return Container(
      width: 190,
      height: 260,
      decoration: BoxDecoration(
